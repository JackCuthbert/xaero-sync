...
class XaeroSyncCommandTest {
    ...
    private val playerId = UUID.fromString("9bb53c09-dd4e-46f0-9177-f9c64959432c")
    ...
    private fun fixture(commandPermission: Boolean = true): Fixture {
        ...
        val player = SenderProbe.player(playerId, "Bedtime", commandPermission, adminPermission = false)
        val console = SenderProbe.console(commandPermission = true, adminPermission = true)
        val runtime = FakeRuntime(OnlinePlayer(playerId, "Bedtime"))
